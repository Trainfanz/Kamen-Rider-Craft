...
public class clawsModel extends ModelBiped
{
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
	{
		...
		if (entity instanceof  EntityLivingBase){
			...
			if (stack.getItem()==RiderItems.birth_driver||stack.getItem()==RiderItems.birth_driver_prototype){
				Minecraft.getMinecraft().renderEngine.bindTexture(new ResourceLocation(Refercence.MODID+":textures/armor/"+item_OOOdriver.get_claws_torso(stack)+".png"));	
			}
		}
		...
		if (entity instanceof  EntityLivingBase){
			...
			if (stack.getItem()==RiderItems.birth_driver){
				Minecraft.getMinecraft().renderEngine.bindTexture(new ResourceLocation(Refercence.MODID+":textures/armor/"+item_OOOdriver.get_claws_r_arms(stack)+".png"));	
			}
		}
		...
		if (entity instanceof  EntityLivingBase){
			ItemStack stack  =   ((EntityLivingBase) entity).getItemStackFromSlot(EntityEquipmentSlot.FEET);
			if (stack.getItem()==RiderItems.birth_driver||stack.getItem()==RiderItems.birth_driver_prototype){
				Minecraft.getMinecraft().renderEngine.bindTexture(new ResourceLocation(Refercence.MODID+":textures/armor/"+item_OOOdriver.get_claws_l_arms(stack)+".png"));	
			}
		}
		...
		if (entity instanceof  EntityLivingBase){
			ItemStack stack  =   ((EntityLivingBase) entity).getItemStackFromSlot(EntityEquipmentSlot.FEET);
			if (stack.getItem()==RiderItems.birth_driver){
				Minecraft.getMinecraft().renderEngine.bindTexture(new ResourceLocation(Refercence.MODID+":textures/armor/"+item_OOOdriver.get_claws_legs(stack)+".png"));	
			}
		}
