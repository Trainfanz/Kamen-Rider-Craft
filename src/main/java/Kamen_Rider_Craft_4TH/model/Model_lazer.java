...
public class Model_lazer extends model_belt_plus
{
	//fields
							...
							if (player.getItemStackFromSlot(EntityEquipmentSlot.LEGS).getItem() == RiderItems.ex_aidlegs){
								if (player.getItemStackFromSlot(EntityEquipmentSlot.CHEST).getItem() == RiderItems.ex_aidtroso){
									if (player.getItemStackFromSlot(EntityEquipmentSlot.HEAD).getItem() == RiderItems.ex_aidhead){
										if (player.getItemStackFromSlot(EntityEquipmentSlot.FEET).getItem() == RiderItems.gamer_driver_lazer){
											if (item_ex_aiddriver.get_core(player.getItemStackFromSlot(EntityEquipmentSlot.FEET), "1")==0&item_ex_aiddriver.get_lock(player.getItemStackFromSlot(EntityEquipmentSlot.FEET))=="blank"){
												...
												Minecraft.getMinecraft().renderEngine.bindTexture(new ResourceLocation(Refercence.MODID+":textures/armor/model_lazer.png"));
