...
public class Itemrider_cards extends Item implements IHasModel
{
	...
	public Itemrider_cards(int NUM,int NUM2,String name)
	{
		...
		}else if (playerIn.getItemStackFromSlot(EntityEquipmentSlot.FEET).getItem() == RiderItems.decadedriver&this!=RiderItems.k_touch_diend||playerIn.getItemStackFromSlot(EntityEquipmentSlot.FEET).getItem() == RiderItems.dark_decadedriver&this!=RiderItems.k_touch_diend&this!=RiderItems.k_touch& this!=RiderItems.decadecard_violent_emotion &this!=RiderItems.diendcard){
