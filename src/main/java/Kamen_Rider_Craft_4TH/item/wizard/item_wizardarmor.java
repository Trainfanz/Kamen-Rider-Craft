...
public class item_wizardarmor extends ItemArmor implements IHasModel
{
	...
	public item_wizardarmor (String name,ArmorMaterial par2EnumArmorMaterial, int par3, EntityEquipmentSlot par4)
	{
