...
public class Item_astroswitch extends Item implements IHasModel
{
	...
	{
		GameRegistry.addShapelessRecipe(new ResourceLocation(Refercence.MODID,"astroswitch_and_"+Thing.getTranslationKey()),new ResourceLocation(Refercence.MODID,"astroswitch"),new ItemStack(this), new Ingredient[]{Ingredient.fromItem(RiderItems.astroswitch),Ingredient.fromItem(Thing)});			
		return this;
	}
