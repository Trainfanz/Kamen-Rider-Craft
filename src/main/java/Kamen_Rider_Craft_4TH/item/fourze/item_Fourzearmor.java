...
public class item_Fourzearmor extends ItemArmor implements IHasModel
{
	...
	public item_Fourzearmor (String name,ArmorMaterial par2EnumArmorMaterial, int par3, EntityEquipmentSlot par4)
	{
