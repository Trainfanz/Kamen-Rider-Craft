...
public class item_ex_aidarmor extends ItemArmor implements IHasModel
{
	...
	public item_ex_aidarmor (String name,ArmorMaterial par2EnumArmorMaterial, int par3, EntityEquipmentSlot par4)
	{
			...
			if (player.getItemStackFromSlot(EntityEquipmentSlot.FEET)!= null){
				...
				if (player.getItemStackFromSlot(EntityEquipmentSlot.FEET).getItem() instanceof item_ex_aiddriver){
					...
					String rider = ((item_ex_aiddriver)player.getItemStackFromSlot(EntityEquipmentSlot.FEET).getItem()).Rider;
						...
						return Refercence.MODID+":textures/armor/"+item_ex_aiddriver.get_lock(player.getItemStackFromSlot(EntityEquipmentSlot.FEET))+"_1.png";
	...
	public ModelBiped getArmorModel(EntityLivingBase living, ItemStack stack, EntityEquipmentSlot slot, ModelBiped defaultModel)
	{
		if(!stack.isEmpty())
		{
			if(stack.getItem() instanceof item_ex_aidarmor)
			{
