...
public class Item_Large_fireball_gun extends ItemBow  implements IHasModel
{
	 private final float attackDamage;
	    private final Item.ToolMaterial material;
		private final Item base;   

	public Item_Large_fireball_gun(String name,ToolMaterial par2EnumToolMaterial, Item item)
	{
		super();
	...
	public void onPlayerStoppedUsing(ItemStack stack, World worldIn, EntityLivingBase entityLiving, int timeLeft)
	{
		if (entityLiving instanceof EntityPlayer)
		{
			...
			if (!worldIn.isRemote)
			{
					...
					EntityFireball fireball =  new EntityLargeFireball(worldIn, entityLiving, 5, 1 ,1);
