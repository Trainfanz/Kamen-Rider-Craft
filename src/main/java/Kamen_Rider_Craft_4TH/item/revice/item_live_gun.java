...
public class item_live_gun extends ItemBow  implements IHasModel
{
	...
	public item_live_gun(String name,ToolMaterial par2EnumToolMaterial, Item item)
	{
		super();
        ...
        this.addPropertyOverride(new ResourceLocation("pull"), new IItemPropertyGetter()
	    {
			@SideOnly(Side.CLIENT)
	           ...
	           {
					if (stack.getItem() == ReiwaRiderItems.live_gun)
					{
						if (entityIn == null)
		                {
		                    return 0.0F;
						...
						else if (entityIn.getItemStackFromSlot(EntityEquipmentSlot.FEET)!= null)
						{
							if (entityIn.getItemStackFromSlot(EntityEquipmentSlot.FEET).getItem() == ReiwaRiderItems.two_sidriver_live)
							{
								...
								if (item_revicedriver.get_core(entityIn.getItemStackFromSlot(EntityEquipmentSlot.FEET),"1")==5)
								{
									return 2;
								}
