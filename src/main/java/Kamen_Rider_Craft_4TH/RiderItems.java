...
public class RiderItems {
	...
	public static Item invading_horseshoe_crab_progrise_key = new Item_progrise_keys(0, 27,"invading_horseshoe_crab_progrise_key").AddToZaia3DPrinter(5).setCreativeTab(Tabs.tabzero_one);
