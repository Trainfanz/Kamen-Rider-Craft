...
public class entity_metal_build extends EntityBossBase
//implements IBossDisplayData
{


 
	public entity_metal_build(World par1World)
	{
		super(par1World);
    ...
    public void onDeath(DamageSource cause)
    {
    	if (!this.world.isRemote){
    		...
    		if (!this.world.isRemote){
        		...
        		this.dropItem(RiderItems.metal_tanktank_full_bottle, 1);
        		this.dropItem(RiderItems.full_bottle, 4);
