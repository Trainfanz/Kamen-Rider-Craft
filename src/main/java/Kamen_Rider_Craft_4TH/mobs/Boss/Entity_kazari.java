...
public class Entity_kazari extends EntityBossBase
//implements IBossDisplayData
{
    
	private String texture;
	public Entity_kazari(World par1World)
	{
		super(par1World);
		...
		this.setItemStackToSlot(EntityEquipmentSlot.FEET,new ItemStack(RiderItems.greeed_blet_kazari));
...
if (!this.world.isRemote){
		...
		{
		case 0:
			this.dropItem(RiderItems.greeed_blet_kazari, 1);
			break;
		}
		...
		{
		case 0:
			this.dropItem(RiderItems.lion, 1);
			break;
		case 1:
			this.dropItem(RiderItems.tora, 1);
			break;
		case 2:
			this.dropItem(RiderItems.cheetah, 1);
			break;
		}
       }
