...
//implements IBossDisplayData
{
	...
	public Entity_ankh_lost(World par1World)
	{
		super(par1World);
		...
		this.setItemStackToSlot(EntityEquipmentSlot.FEET,new ItemStack(RiderItems.greeed_blet_ankh_lost));
...
if (!this.world.isRemote){
		...
		{
		case 0:
			this.dropItem(RiderItems.greeed_blet_ankh_lost, 1);
			break;
		}
		...
		case 0:
			...
			break;
		case 1:
			this.dropItem(RiderItems.kujaku, 1);
			break;
		case 2:
			this.dropItem(RiderItems.condor, 1);
			break;
		}
       }
