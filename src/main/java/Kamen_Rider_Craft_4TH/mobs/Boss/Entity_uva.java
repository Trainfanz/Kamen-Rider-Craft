...
public class Entity_uva extends EntityBossBase
//implements IBossDisplayData
{
    
	private String texture;
	public Entity_uva(World par1World)
	{
		super(par1World);
		...
		this.setItemStackToSlot(EntityEquipmentSlot.FEET,new ItemStack(RiderItems.greeed_blet_uva));
...
if (!this.world.isRemote){
		...
		{
		case 0:
			this.dropItem(RiderItems.greeed_blet_uva, 1);
			break;
		}
		...
		case 0:
			...
			break;
		case 1:
			this.dropItem(RiderItems.kuwagata, 1);
			break;
		case 2:
			this.dropItem(RiderItems.kamakiri, 1);
			break;
		}
       }
