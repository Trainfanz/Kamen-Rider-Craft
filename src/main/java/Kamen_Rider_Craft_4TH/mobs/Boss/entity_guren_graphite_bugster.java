...
public class entity_guren_graphite_bugster extends EntityBossBase
//implements IBossDisplayData
{
    
	public entity_guren_graphite_bugster(World par1World)
	{
		super(par1World);
    ...
    public void onDeath(DamageSource cause)
    {
    	...
    	{
    		this.dropItem(RiderItems.drago_knight_hunter_z_gasha_trophy, 1);
