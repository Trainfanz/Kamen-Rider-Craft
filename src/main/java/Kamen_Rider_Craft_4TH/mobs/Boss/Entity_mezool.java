...
public class Entity_mezool extends EntityBossBase
//implements IBossDisplayData
{
    
	private String texture;
	public Entity_mezool(World par1World)
	{
		super(par1World);
		...
		this.setItemStackToSlot(EntityEquipmentSlot.FEET,new ItemStack(RiderItems.greeed_blet_mezool));
...
if (!this.world.isRemote){
		...
		{
		case 0:
			this.dropItem(RiderItems.greeed_blet_mezool, 1);
			break;
		}
		...
		{
		case 0:
			this.dropItem(RiderItems.shachi, 1);
			break;
		case 1:
			this.dropItem(RiderItems.unagi, 1);
			break;
		case 2:
			this.dropItem(RiderItems.tako, 1);
			break;
		}
       }
