...
public class entity_motors_bugster extends EntityBossBase
//implements IBossDisplayData
{
    
	public entity_motors_bugster(World par1World)
	{
		super(par1World);
    ...
    public void onDeath(DamageSource cause)
    {
    	...
    	{
    		this.dropItem(RiderItems.bakusou_bike_gasha_trophy, 1);
