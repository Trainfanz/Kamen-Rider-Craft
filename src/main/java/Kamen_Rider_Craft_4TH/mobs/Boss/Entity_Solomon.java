	...
	public class Entity_Solomon extends EntityBossBase
	//implements IBossDisplayData
	{
		...
		protected void initEntityAI()
		{
			...
			this.tasks.addTask(4, new Entity_Solomon.AIFireballAttack(this));
		...
		{
			private final Entity_Solomon blaze;
			private int attackStep;
			private int attackTime;

			public AIFireballAttack(Entity_Solomon blazeIn)
			{
				this.blaze = blazeIn;
				this.setMutexBits(3);
			}
