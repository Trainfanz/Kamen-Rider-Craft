...
public class Entity_muchiri extends EntityBossBase
//implements IBossDisplayData
{
    
	private String texture;
	public Entity_muchiri(World par1World)
	{
		super(par1World);
		...
		this.setItemStackToSlot(EntityEquipmentSlot.FEET,new ItemStack(RiderItems.greeed_blet_muchiri));
...
if (!this.world.isRemote){
		...
		{
		case 0:
			this.dropItem(RiderItems.greeed_blet_muchiri, 1);
			break;
		}
		...
		{
		case 0:
			this.dropItem(RiderItems.mukade, 1);
			break;
		case 1:
			this.dropItem(RiderItems.hachi, 1);
			break;
		case 2:
			this.dropItem(RiderItems.ari, 1);
			break;
		}
       }
