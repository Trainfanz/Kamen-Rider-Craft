...
public class entity_vernier_bugster extends EntityBossBase
//implements IBossDisplayData
{
    
	public entity_vernier_bugster(World par1World)
	{
		super(par1World);
    ...
    public void onDeath(DamageSource cause)
    {
    	...
    	{
    		this.dropItem(RiderItems.jet_combat_gasha_trophy, 1);
