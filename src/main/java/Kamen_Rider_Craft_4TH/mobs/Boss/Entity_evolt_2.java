...
public class Entity_evolt_2 extends EntityBossBase
//implements IBossDisplayData
{


 
	public Entity_evolt_2(World par1World)
	{
		super(par1World);
...
if (!this.world.isRemote){
	this.dropItem(RiderItems.full_bottle, 2);
		if (this.getAttackTarget()instanceof EntityPlayer){
			 ...
			 EntityBossBase entityboss  = new Entity_evolt_3(world);

			playerIn.sendMessage( new TextComponentString(TextFormatting.WHITE+"Ready, go! Feverflow! Fuhahahahahaha! Fuhahahahahahahaha!"));
