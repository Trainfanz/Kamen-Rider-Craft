...
public class Entity_White_Woz extends EntityBossBase
//implements IBossDisplayData
{
    
	private String texture;
	public Entity_White_Woz(World par1World)
	{
		super(par1World);
		...
		this.setItemStackToSlot(EntityEquipmentSlot.FEET,new ItemStack(RiderItems.beyondriver));
	...
	public void onEntityUpdate(){
		...
		case 0:
			...
			this.setItemStackToSlot(EntityEquipmentSlot.MAINHAND,new ItemStack(RiderItems.zikan_despear_tsue));
			break;
		case 1:
			item_zikudriver.set_lock(this.getItemStackFromSlot(EntityEquipmentSlot.FEET),23);
			this.setItemStackToSlot(EntityEquipmentSlot.MAINHAND,new ItemStack(RiderItems.zikan_despear_kama));
			break;
		case 2:
			item_zikudriver.set_lock(this.getItemStackFromSlot(EntityEquipmentSlot.FEET),24);
			this.setItemStackToSlot(EntityEquipmentSlot.MAINHAND,new ItemStack(RiderItems.zikan_despear));
			break;
...
if (!this.world.isRemote){
		...
		case 0:
			...
			break;
		case 1:
			this.dropItem(RiderItems.kikai_miridewatch, 1);
			break;
		case 2:
			this.dropItem(RiderItems.shinobi_miridewatch, 1);
			break;
		}
       }
