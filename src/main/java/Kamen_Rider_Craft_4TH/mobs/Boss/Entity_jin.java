...
//implements IBossDisplayData
{
	...
	public Entity_jin(World par1World)
	{
		...
		this.setItemStackToSlot(EntityEquipmentSlot.FEET,new ItemStack(RiderItems.forceriser_jin));
    ...
    public void onDeath(DamageSource cause)
    {
		...
		this.dropItem(RiderItems.jin_progrise_key, 1);
		this.dropItem(RiderItems.flying_falcon_progrise_key, 1);
	
		switch (this.rand.nextInt(5))
		{
		case 0:
			this.dropItem(RiderItems.burning_falcon_progrise_key, 1);
			break;
		}
       }
