...
public class Entity_jin extends EntityBossBase
//implements IBossDisplayData
{
    
	private String texture;
	public Entity_jin(World par1World)
	{
		super(par1World);
		...
		this.setItemStackToSlot(EntityEquipmentSlot.FEET,new ItemStack(ReiwaRiderItems.forceriser_jin));
    ...
    public void onDeath(DamageSource cause)
    {
		...
		this.dropItem(ReiwaRiderItems.jin_progrise_key, 1);
		this.dropItem(ReiwaRiderItems.flying_falcon_progrise_key, 1);
	
		switch (this.rand.nextInt(5))
		{
		case 0:
			this.dropItem(ReiwaRiderItems.burning_falcon_progrise_key, 1);
			break;
		}
       }
