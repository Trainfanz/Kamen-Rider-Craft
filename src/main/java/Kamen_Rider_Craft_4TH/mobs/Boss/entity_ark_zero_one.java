...
public class entity_ark_zero_one extends EntityBossBase
//implements IBossDisplayData
{
    
	private String texture;
	public entity_ark_zero_one(World par1World)
	{
		super(par1World);
		this.setItemStackToSlot(EntityEquipmentSlot.FEET,new ItemStack(RiderItems.hiden_zero_one_driver_azu));
