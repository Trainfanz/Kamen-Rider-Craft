...
public class entity_gatton_bugster extends EntityBossBase
//implements IBossDisplayData
{
    
	public entity_gatton_bugster(World par1World)
	{
		super(par1World);
    ...
    public void onDeath(DamageSource cause)
    {
    	...
    	{
    		this.dropItem(RiderItems.gekitotsu_robots_gasha_trophy, 1);
