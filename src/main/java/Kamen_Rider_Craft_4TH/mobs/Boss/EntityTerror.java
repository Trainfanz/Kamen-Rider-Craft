...
public class EntityTerror extends EntityBossBase
//implements IBossDisplayData
{


	private String texture;
	public EntityTerror(World par1World)
	{
		super(par1World);
	}
	...
	protected void initEntityAI()
	{
		...
		this.tasks.addTask(4, new EntityTerror.AIFireballAttack(this));
	...
	public void onDeath(DamageSource cause)
	{
		if (!this.world.isRemote){
			...
			this.dropItem(RiderItems.terror_memory, 1);
			this.dropItem(RiderItems.unrefined_memory_g, 10);
			this.dropItem(RiderItems.unrefined_memory_s, 10);
		}
	}
	...
	{
		private final EntityTerror blaze;
		private int attackStep;
		private int attackTime;

		public AIFireballAttack(EntityTerror blazeIn)
		{
			this.blaze = blazeIn;
			this.setMutexBits(3);
		}
