...
public class Entity_power_up_core extends EntityBossBase
{

	private String texture;
	public Entity_power_up_core(World par1World)
	{
		super(par1World);
		...
		this.setItemStackToSlot(EntityEquipmentSlot.FEET,new ItemStack(RiderItems.core_driver_power_up));
	...
	public void onDeath(DamageSource cause)
	{
		if (!this.world.isRemote){
			...
			this.dropItem(RiderItems.core_driver_power_up, 1);
			this.dropItem(RiderItems.sasori_new, 1);
			this.dropItem(RiderItems.kani_new, 1);
			this.dropItem(RiderItems.ebi_new, 1);
			this.dropItem(RiderItems.black_rx_ridewatch, 1);
