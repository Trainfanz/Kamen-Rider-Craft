...
public class Entity_commander_dopant extends EntityBossBase
//implements IBossDisplayData
{
	public Entity_commander_dopant(World par1World)
	{
		super(par1World);
	...
	public void onDeath(DamageSource cause)
	{
		if (!this.world.isRemote){
			...
			this.dropItem(RiderItems.commander_memory_enhancing_adapter, 1);
