...
public class Entity_wiseman extends EntityBossBase
//implements IBossDisplayData
{
	...
	public Entity_wiseman(World par1World)
	{
		super(par1World);
		this.setItemStackToSlot(EntityEquipmentSlot.MAINHAND,new ItemStack(RiderItems.hammelcane));
		...
		this.setItemStackToSlot(EntityEquipmentSlot.FEET,new ItemStack(RiderItems.whitewizardriver));
		this.setItemStackToSlot(EntityEquipmentSlot.LEGS,new ItemStack(RiderItems.wizardlegs));	
	}
	protected void initEntityAI()
	{
		this.tasks.addTask(0, new EntityAISwimming(this));
		this.tasks.addTask(4, new Entity_wiseman.AIFireballAttack(this));
    ...
    private boolean teleportTo(double x, double y, double z)
    {
    	if (this.getAttackTarget()instanceof EntityPlayer){
			...
			playerIn.sendStatusMessage(new TextComponentString(TextFormatting.LIGHT_PURPLE+"Teleport Now!"), true);
    	}
...
if (!this.world.isRemote){
   		...
   		this.dropItem(RiderItems.wizardgem, 10);
   		this.dropItem(RiderItems.wizardgem_cyan, 2);
   		this.dropItem(RiderItems.wizardgem_violet, 5);
   		this.dropItem(RiderItems.wiseman_ring, 1);
   		this.dropItem(RiderItems.philosophers_stone, 1);
   		...
   		{
   		case 3:
   			this.dropItem(RiderItems.whitewizardriverf, 1);
   			break;	
	...
	{
		private final Entity_wiseman blaze;
		private int attackStep;
		private int attackTime;

		public AIFireballAttack(Entity_wiseman entity_wiseman)
		{
			this.blaze = entity_wiseman;
			this.setMutexBits(3);
		}
			...
			else { if (d0 < this.getFollowDistance() * this.getFollowDistance()) 
			{
				...
				if (this.attackTime <= 0)
				{
					...
					if (this.attackStep > 1)
					{
						...
						if (blaze.getAttackTarget()instanceof EntityPlayer){
							EntityPlayer playerIn=	(EntityPlayer) blaze.getAttackTarget();
							playerIn.sendStatusMessage(new TextComponentString(TextFormatting.LIGHT_PURPLE+"Explosion Now!"), true);
