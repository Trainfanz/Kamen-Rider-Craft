...
public class Entity_ankh_complete extends EntityBossBase
//implements IBossDisplayData
{
    
	private String texture;
	public Entity_ankh_complete(World par1World)
	{
		super(par1World);
		...
		this.setItemStackToSlot(EntityEquipmentSlot.FEET,new ItemStack(RiderItems.greeed_blet_ankh));
...
if (!this.world.isRemote){
   		...
   		this.dropItem(RiderItems.cellmedal, 6);
			...
			this.dropItem(RiderItems.greeed_blet_ankh, 1);
