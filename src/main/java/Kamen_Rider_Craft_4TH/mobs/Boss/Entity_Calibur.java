		...
		if (this.getItemStackFromSlot(EntityEquipmentSlot.FEET).getItem()==RiderItems.jaken_caliburdriver){
			if (this.getHealth()<30&item_saberdriver.get_core_for_forms(this.getItemStackFromSlot(EntityEquipmentSlot.FEET), "f")!=1) {
				if (this.getAttackTarget()instanceof EntityPlayer){
					...
					playerIn.sendMessage( new TextComponentString(TextFormatting.DARK_RED+"Jump out the book, open it and burst."));
					playerIn.sendMessage( new TextComponentString(TextFormatting.DARK_RED+"The fear of the darkness"));
				...
				item_zero_onedriver.set_core(this.getItemStackFromSlot(EntityEquipmentSlot.FEET),1, "f");			
			}
			}
