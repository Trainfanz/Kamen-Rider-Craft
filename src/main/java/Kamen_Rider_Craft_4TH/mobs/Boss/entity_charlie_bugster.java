...
public class entity_charlie_bugster extends EntityBossBase
//implements IBossDisplayData
{
    
	public entity_charlie_bugster(World par1World)
	{
		super(par1World);
    ...
    public void onDeath(DamageSource cause)
    {
    	...
    	{
    		this.dropItem(RiderItems.shakariki_sports_gasha_trophy, 1);
