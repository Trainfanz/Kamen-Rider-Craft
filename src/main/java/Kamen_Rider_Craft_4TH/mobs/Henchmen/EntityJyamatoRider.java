...
public class EntityJyamatoRider extends Entity_pawn_jyamato
{
	public EntityJyamatoRider(World par1World)
	{
		...
		this.setItemStackToSlot(EntityEquipmentSlot.FEET,new ItemStack(ReiwaRiderItems.desire_driver_jyamato));
