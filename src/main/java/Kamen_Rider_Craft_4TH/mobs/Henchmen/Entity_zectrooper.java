...
public class Entity_zectrooper extends Entity_base_henchmen
{
	public Entity_zectrooper(World par1World)
	{
		super(par1World);
		...
		this.setItemStackToSlot(EntityEquipmentSlot.FEET,new ItemStack(RiderItems.zectrooper_belt));
