...
public class mobsCore {
	...
	public static void Addmob(){
		...
		EntityRegistry.registerModEntity(new  ResourceLocation(Refercence.MODID+":GodWarfareAgentMob"),Entitygod_warfare_agent.class, "GodWarfareAgentMob", newMobID(), TokuCraft_core.instance, 80, 3, false, 000000,0xFFFFFF);
		...
		EntityRegistry.registerModEntity(new  ResourceLocation(Refercence.MODID+":RedFollowerMob"),Entityred_follower.class, "RedFollowerMob", newMobID(), TokuCraft_core.instance, 80, 3, false, 000000,0xFFFFFF);
