...
public class Faiz_Rider_Items {
	...
	public static final DeferredRegister<Item> ITEMS = DeferredRegister.create(ForgeRegistries.ITEMS, KamenRiderCraftCore.MODID);
	   ...
	   public static final RegistryObject<SwordItem> FAIZ_EDGE = ITEMS.register("faiz_edge",
	            () -> new BaseSwordItem(Tiers.DIAMOND, 5, 3.5f, new Item.Properties()).AddToTabList(RiderTabs.FAIZ_TAB_ITEM));
		public static final RegistryObject<BaseBlasterItem> FAIZ_BLASTER = ITEMS.register("faiz_blaster",
		        () -> new BaseBlasterItem(Tiers.DIAMOND, 4, 3.5f, new Item.Properties()).AddToTabList(RiderTabs.FAIZ_TAB_ITEM));
	   ...
	   public static final RegistryObject<SwordItem> ORGA_STLANZER = ITEMS.register("orga_stlanzer",
		...
		public static final RegistryObject<Item> FAIZHELMET = ITEMS.register("faizhead",
	            () -> new RiderArmorItem(ArmorMaterials.DIAMOND, ArmorItem.Type.HELMET, new Item.Properties()).AddToTabList(RiderTabs.FAIZ_TAB_ITEM));
	    public static final RegistryObject<Item> FAIZCHESTPLATE = ITEMS.register("faiztroso",
	            () -> new RiderArmorItem(ArmorMaterials.DIAMOND, ArmorItem.Type.CHESTPLATE, new Item.Properties()).AddToTabList(RiderTabs.FAIZ_TAB_ITEM));
	    public static final RegistryObject<Item> FAIZLEGGINGS = ITEMS.register("faizlegs",
	            () -> new RiderArmorItem(ArmorMaterials.DIAMOND, ArmorItem.Type.LEGGINGS, new Item.Properties()).AddToTabList(RiderTabs.FAIZ_TAB_ITEM));
	    ...
	    public static final RegistryObject<Item> FAIZ_AXEL_MISSION_MEMORY = ITEMS.register("faiz_axel_mission_memory",
	            () -> new RiderFormChangeItem(new Item.Properties(),0,"_axel","faiz","faiz_driver_belt",
	            		new MobEffectInstance(MobEffects.DAMAGE_BOOST, 40, 2,true,false),
	    ...
	    public static final RegistryObject<Item> FAIZ_BLASTER_MISSION_MEMORY = ITEMS.register("faiz_blaster_mission_memory",
	            () -> new RiderFormChangeItem(new Item.Properties(),0,"_blaster","faiz","faiz_driver_belt",
	    ...
	    public static final RegistryObject<Item> FAIZ_DRIVER = ITEMS.register("faiz_driver",
		           () -> new RiderDriverItem(ArmorMaterials.DIAMOND,"faiz",FAIZ_MISSION_MEMORY ,FAIZHELMET, FAIZCHESTPLATE, FAIZLEGGINGS , new Item.Properties()).AddToTabList(RiderTabs.FAIZ_TAB_ITEM));

	    public static final RegistryObject<Item> KAIXA_DRIVER = ITEMS.register("kaixa_driver",
		           () -> new RiderDriverItem(ArmorMaterials.DIAMOND,"kaixa",KAIXA_MISSION_MEMORY ,FAIZHELMET, FAIZCHESTPLATE, FAIZLEGGINGS , new Item.Properties()).AddToTabList(RiderTabs.FAIZ_TAB_ITEM));
	    
	    public static final RegistryObject<Item> DELTA_DRIVER = ITEMS.register("delta_driver",
		           () -> new RiderDriverItem(ArmorMaterials.DIAMOND,"delta",DELTA_MISSION_MEMORY ,FAIZHELMET, FAIZCHESTPLATE, FAIZLEGGINGS , new Item.Properties()).AddToTabList(RiderTabs.FAIZ_TAB_ITEM));
	 
	    public static final RegistryObject<Item> PSYGA_DRIVER = ITEMS.register("psyga_driver",
		           () -> new RiderDriverItem(ArmorMaterials.DIAMOND,"psyga",PSYGA_MISSION_MEMORY ,FAIZHELMET, FAIZCHESTPLATE, FAIZLEGGINGS , new Item.Properties()).AddToTabList(RiderTabs.FAIZ_TAB_ITEM));
	    
	    public static final RegistryObject<Item> ORGA_DRIVER = ITEMS.register("orga_driver",
		           () -> new RiderDriverItem(ArmorMaterials.DIAMOND,"orga",ORGA_MISSION_MEMORY ,FAIZHELMET, FAIZCHESTPLATE, FAIZLEGGINGS , new Item.Properties()).AddToTabList(RiderTabs.FAIZ_TAB_ITEM));
	    
	    public static final RegistryObject<Item> SMARTBUCKLE = ITEMS.register("smartbuckle",
		           () -> new RiderDriverItem(ArmorMaterials.DIAMOND,"riotrooper",FAIZ_MISSION_MEMORY ,FAIZHELMET, FAIZCHESTPLATE, FAIZLEGGINGS , new Item.Properties()).AddToTabList(RiderTabs.FAIZ_TAB_ITEM));
