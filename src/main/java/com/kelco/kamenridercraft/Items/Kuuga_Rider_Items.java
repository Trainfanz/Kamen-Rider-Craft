...
public class Kuuga_Rider_Items {
    ...
    public static final RegistryObject<SwordItem> DRAGON_ROD = ITEMS.register("dragon_rod",
            () -> new BaseSwordItem(Tiers.DIAMOND, 5, 3.5f, new Item.Properties()).AddToTabList(RiderTabs.KUUGA_TAB_ITEM));
	public static final RegistryObject<BaseBlasterItem> PEGASUS_BOWGUN = ITEMS.register("pegasus_bowgun",
	        () -> new BaseBlasterItem(Tiers.DIAMOND, 4, 3.5f, new Item.Properties()).AddToTabList(RiderTabs.KUUGA_TAB_ITEM));
	...
	public static final RegistryObject<Item> KUUGAHELMET = ITEMS.register("kuugahead",
            () -> new RiderArmorItem(ArmorMaterials.DIAMOND, ArmorItem.Type.HELMET, new Item.Properties()).AddToTabList(RiderTabs.KUUGA_TAB_ITEM));
    public static final RegistryObject<Item> KUUGACHESTPLATE = ITEMS.register("kuugatroso",
            () -> new RiderArmorItem(ArmorMaterials.DIAMOND, ArmorItem.Type.CHESTPLATE, new Item.Properties()).AddToTabList(RiderTabs.KUUGA_TAB_ITEM));
    public static final RegistryObject<Item> KUUGALEGGINGS = ITEMS.register("kuugalegs",
            () -> new RiderArmorItem(ArmorMaterials.DIAMOND, ArmorItem.Type.LEGGINGS, new Item.Properties()).AddToTabList(RiderTabs.KUUGA_TAB_ITEM));
    ...
    public static final RegistryObject<Item> ARCLE = ITEMS.register("arcle",
	           () -> new RiderDriverItem(ArmorMaterials.DIAMOND,"kuuga",KUUGA_MIGHTY ,KUUGAHELMET, KUUGACHESTPLATE,KUUGALEGGINGS , new Item.Properties()).AddToTabList(RiderTabs.KUUGA_TAB_ITEM));
