...
public class type_tire extends ModelBiped
{
	...
	public void render(Entity par1Entity, float par2, float par3, float par4, float par5, float par6, float par7)
	{
		...
		if (par1Entity instanceof EntityLivingBase){
			...
			if (player.getEquipmentInSlot(1)!=null){
				if (player.getEquipmentInSlot(1).getItem()== RiderItems.break_gunner_2){
					
				}
				else if (player.getEquipmentInSlot(1).getItem() == RiderItems.mach_driver_honoh){

					if (item_drivedriver.get_core(player.getEquipmentInSlot(1))==1||item_drivedriver.get_core(player.getEquipmentInSlot(1))==4){
						GL11.glPushMatrix();
						...
						Minecraft.getMinecraft().renderEngine.bindTexture(new ResourceLocation("kamenridercraftv3:textures/armor/kourin_dead_heat_tire.png"));
						this.Shape2.render(par7);
						GL11.glPopMatrix();


					}else if (item_drivedriver.get_core(player.getEquipmentInSlot(1))==2||item_drivedriver.get_core(player.getEquipmentInSlot(1))==7){
						GL11.glPushMatrix();
						GL11.glScalef(0.75f, 0.75f, 0.75f);
						...
						this.Shape2.render(par7);
						GL11.glPopMatrix();
					}else if (item_drivedriver.get_core(player.getEquipmentInSlot(1))==5){
				...
				}else if (item_drivedriver.get_core(player.getEquipmentInSlot(1))==1){
					GL11.glPushMatrix();
					if (this.isSneak){
						this.Shape2.offsetY=0.2f;
					}
					this.Shape2.render(par7);
					GL11.glPopMatrix();
				}else if (item_drivedriver.get_core(player.getEquipmentInSlot(1))==7){
					GL11.glPushMatrix();
					...
					body10.render(par7);
					GL11.glPopMatrix();
				}else if (item_drivedriver.get_core(player.getEquipmentInSlot(1))==6){
					GL11.glPushMatrix();
					GL11.glScalef(1.2f, 1.2f, 1.2f);
					if (this.isSneak){
						this.Shape1.offsetY=0.1f;
				...
				}else if (item_drivedriver.get_core(player.getEquipmentInSlot(1))==4){
					GL11.glPushMatrix();
					...
					GL11.glPopMatrix();
				}else if (item_drivedriver.get_core(player.getEquipmentInSlot(1))==8||item_drivedriver.get_core(player.getEquipmentInSlot(1))==12){
					GL11.glPushMatrix();
					GL11.glScalef(1f, 1f, 1f);
	...
	public void setRotationAngles(float par1, float par2, float par3, float par4, float par5, float par6, Entity par7Entity)
	{
		...
		if (player.getEquipmentInSlot(1)!=null){
			...
			if (player.getEquipmentInSlot(1).getItem() == RiderItems.mach_driver_honoh){
