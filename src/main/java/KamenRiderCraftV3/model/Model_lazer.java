...
public class Model_lazer extends ModelBiped
{
	//fields
	...
	public Model_lazer()
	{
		...
		Shape2.setRotationPoint(-2F, 4F, -8F);
		...
		Shape3.setRotationPoint(1F, 9.5F, -8F);
		...
		Shape4.setRotationPoint(0F, 7F, 10F);
		Shape4.setTextureSize(64, 128);
		Shape4.mirror = true;
		setRotation(Shape4, 0F, 0F, 0F);

		Shape5 = new ModelRenderer(this, 21, 25);
		Shape5.addBox(0F, 0F, 0F, 5, 2, 8);
		Shape5.setRotationPoint(-1F, 8F, 2F);
		Shape5.setTextureSize(64, 128);
		Shape5.mirror = true;
		setRotation(Shape5, 0.186557F, 0F, 0F);
		...
		Shape7.addBox(0F, 0F, 0F, 1, 5, 6);
		Shape7.setRotationPoint(4.5F, 6F, -10F);
		Shape7.setTextureSize(64, 128);
		Shape7.mirror = true;
		setRotation(Shape7, 0F, 0F, 0F);

		Shape8 = new ModelRenderer(this, 18, 13);
		Shape8.addBox(0F, 0F, 0F, 1, 5, 6);
		Shape8.setRotationPoint(-2.5F, 6F, -10F);
		Shape8.setTextureSize(64, 128);
		Shape8.mirror = true;
		setRotation(Shape8, 0F, 0F, 0F);

		Shape9 = new ModelRenderer(this, 0, 20);
		Shape9.addBox(0F, 0F, 0F, 1, 4, 7);
		Shape9.setRotationPoint(4F, 10F, 0F);
		Shape9.setTextureSize(64, 128);
		Shape9.mirror = false;
		setRotation(Shape9, 0.186557F, 0F, 0F);

		Shape10 = new ModelRenderer(this, 0, 20);
		Shape10.addBox(0F, 0F, 0F, 1, 4, 7);
		Shape10.setRotationPoint(-2F, 10F, 0F);
		Shape10.setTextureSize(64, 128);
		Shape10.mirror = true;
		setRotation(Shape10, 0.186557F, 0F, 0F);

		Shape11 = new ModelRenderer(this, 38, 101);
		Shape11.addBox(0F, 0F, 0F, 5, 3, 8);
		Shape11.setRotationPoint(-1F, 8F, -5F);
		Shape11.setTextureSize(64, 128);
		Shape11.mirror = true;
		setRotation(Shape11, 0F, 0F, 0F);

		Shape12 = new ModelRenderer(this, 48, 87);
		Shape12.addBox(0F, 0F, 0F, 7, 4, 1);
		Shape12.setRotationPoint(-2F, 11F, -8F);
		Shape12.setTextureSize(64, 128);
		Shape12.mirror = true;
		setRotation(Shape12, 0.2609142F, 0F, 0F);
		...
		Shape24.mirror = true;
		setRotation(Shape24, 1.316934F, 0F, 0F);
		...
		Shape26.mirror = true;
		setRotation(Shape26, 1.316934F, 0F, 0F);
		...
		Shape40 = new ModelRenderer(this, 38, 112);
		Shape40.addBox(0F, 0F, 0F, 4, 2, 9);
		Shape40.setRotationPoint(-0.5F, 7.5F, 2F);
		Shape40.setTextureSize(64, 128);
		Shape40.mirror = true;
		setRotation(Shape40, 0.186557F, 0F, 0F);

		Shape41 = new ModelRenderer(this, 40, 92);
		Shape41.addBox(0F, 0F, 0F, 4, 1, 8);
		Shape41.setRotationPoint(-0.5F, 7F, -3F);
		Shape41.setTextureSize(64, 128);
		Shape41.mirror = true;
		setRotation(Shape41, 0F, 0F, 0F);

		Shape42 = new ModelRenderer(this, 40, 39);
		Shape42.addBox(0F, 0F, -2F, 6, 5, 6);
		Shape42.setRotationPoint(-1.5F, 2.5F, -12F);
		Shape42.setTextureSize(64, 128);
		Shape42.mirror = true;
		setRotation(Shape42, 0F, 0F, 0F);

		Shape43 = new ModelRenderer(this, 0, 121);
		Shape43.addBox(0F, 0F, -2F, 12, 3, 1);
		Shape43.setRotationPoint(-4.5F, 2F, -8F);
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
	{
		...
		if (entity instanceof EntityLivingBase){
							...
							if (player.getEquipmentInSlot(4).getItem() == RiderItems.ex_aidhead){
								if (player.getEquipmentInSlot(3).getItem() == RiderItems.ex_aidtroso){
									if (player.getEquipmentInSlot(2).getItem() == RiderItems.ex_aidlegs){
										if (player.getEquipmentInSlot(1).getItem() == RiderItems.gamer_driver_lazer){
											if (item_ex_aiddriver.get_core(player.getEquipmentInSlot(1), "1")==0&item_ex_aiddriver.get_lock(player.getEquipmentInSlot(1))=="blank"){
												...
												Minecraft.getMinecraft().renderEngine.bindTexture(new ResourceLocation("KamenRiderCraftV3:textures/armor/model_lazer.png"));
			...
			EntityItem entItem = new EntityItem(Minecraft.getMinecraft().thePlayer.getEntityWorld(), 0D, 0D, 0D,player.getEquipmentInSlot(1));
			...
			if (item_ex_aiddriver.get_core(player.getEquipmentInSlot(1),"1")==4||item_ex_aiddriver.get_core(player.getEquipmentInSlot(1),"1")==5||item_ex_aiddriver.get_core(player.getEquipmentInSlot(1),"1")==6){
			...
			Minecraft.getMinecraft().getItemRenderer().renderItem(player, player.getEquipmentInSlot(1),null);
