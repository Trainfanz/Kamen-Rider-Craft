...
public class BipedLockseed2 extends ModelBiped
{
			...
			if (stack!=null){
				if (stack.getItem() instanceof item_Gaimdriver){
					if (item_Gaimdriver.get_lock(stack)=="energy_dragon_fruits_arms"){
						...
						Minecraft.getMinecraft().renderEngine.bindTexture(new ResourceLocation("KamenRiderCraftv3:textures/armor/energy_prototype_dragon_fruits_arms.png"));

					}else if (item_Gaimdriver.get_lock(stack)=="blood_zakuro_arms"){

						Minecraft.getMinecraft().renderEngine.bindTexture(new ResourceLocation("KamenRiderCraftv3:textures/armor/blood_orange_arms.png"));
					...
					if (stack.getItem()==RiderItems.eyecon_driver_g){
						...
						Minecraft.getMinecraft().renderEngine.bindTexture(new ResourceLocation("KamenRiderCraftv3:textures/armor/grateful_damashii_2.png"));

					}
				}else if (stack.getItem() instanceof item_ex_aiddriver){
					
				
						Minecraft.getMinecraft().renderEngine.bindTexture(new ResourceLocation("KamenRiderCraftv3:textures/armor/"+item_ex_aiddriver.get_lock(stack) +"_2.png"));
				
				}
				else if (stack.getItem() instanceof item_zi_o_driver)
				{
					EntityLivingBase player = ((EntityLivingBase)entity);
					String rider = ((item_zi_o_driver)player.getEquipmentInSlot(1).getItem()).Rider;
					
					Minecraft.getMinecraft().renderEngine.bindTexture(new ResourceLocation("KamenRiderCraftv3:textures/armor/"+rider+"_"+item_zi_o_driver.get_lock(stack) +"_2.png"));
				}
			}
		}
