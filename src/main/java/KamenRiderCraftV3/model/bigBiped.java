...
public class bigBiped extends BipedLockseed
{
	public bigBiped()
	{
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
	{
		...
		if (entity instanceof  EntityLivingBase){
			...
			if (((EntityLivingBase) entity).getEquipmentInSlot(1)!=null){
				 ...
				 if (((EntityLivingBase) entity).getEquipmentInSlot(1).getItem() instanceof item_ex_aiddriver){
					if (item_ex_aiddriver.get_core(((EntityLivingBase) entity).getEquipmentInSlot(1),"1")==6){
		...
		if (entity instanceof  EntityLivingBase){
			...
			}else if (((EntityLivingBase) entity).getEquipmentInSlot(1).getItem() instanceof item_ex_aiddriver){


				Minecraft.getMinecraft().renderEngine.bindTexture(new ResourceLocation("KamenRiderCraftv3:textures/armor/"+item_ex_aiddriver.get_lock(((EntityLivingBase) entity).getEquipmentInSlot(1)) +"_2.png"));
