...
public class model_all_dragon extends ModelBiped
{
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
	{
		...
		if (entity instanceof EntityLivingBase){
			...
			if (player.getEquipmentInSlot(1).getItem() == RiderItems.beastdriver){
			...
			if (player.getEquipmentInSlot(1).getItem() == RiderItems.wizardriver){
				if(item_wizarddriver.get_core(player.getEquipmentInSlot(1), "2")==1||item_wizarddriver.get_core(player.getEquipmentInSlot(1), "2")==4||item_wizarddriver.get_core(player.getEquipmentInSlot(1), "2")==8||item_wizarddriver.get_core(player.getEquipmentInSlot(1), "2")==9){
				...
				}if(item_wizarddriver.get_core(player.getEquipmentInSlot(1), "2")==1||item_wizarddriver.get_core(player.getEquipmentInSlot(1), "2")==5||item_wizarddriver.get_core(player.getEquipmentInSlot(1), "2")==3||item_wizarddriver.get_core(player.getEquipmentInSlot(1), "2")==8||item_wizarddriver.get_core(player.getEquipmentInSlot(1), "2")==9){
				...
				}if(item_wizarddriver.get_core(player.getEquipmentInSlot(1), "2")==1||item_wizarddriver.get_core(player.getEquipmentInSlot(1), "2")==6||item_wizarddriver.get_core(player.getEquipmentInSlot(1), "2")==3||item_wizarddriver.get_core(player.getEquipmentInSlot(1), "2")==8||item_wizarddriver.get_core(player.getEquipmentInSlot(1), "2")==9){
				...
				if(item_wizarddriver.get_core(player.getEquipmentInSlot(1), "2")==1||item_wizarddriver.get_core(player.getEquipmentInSlot(1), "2")==7||item_wizarddriver.get_core(player.getEquipmentInSlot(1), "2")==3||item_wizarddriver.get_core(player.getEquipmentInSlot(1), "2")==8||item_wizarddriver.get_core(player.getEquipmentInSlot(1), "2")==9){
