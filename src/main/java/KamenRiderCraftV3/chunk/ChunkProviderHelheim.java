...
public class ChunkProviderHelheim implements IChunkProvider
{
    /** RNG. */
    private Random rand;
    ...
    /** A NoiseGeneratorOctave	Is used in generating terrain */
    ...
    public ChunkProviderHelheim(World worldIn, long p_i45636_2_, boolean p_i45636_4_, String p_i45636_5_)
    {
        {
