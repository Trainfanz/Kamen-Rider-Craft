...
public class item_kuugadriver extends ItemArmor
{
	...
	public item_kuugadriver (ArmorMaterial par2EnumArmorMaterial, int par3, int par4, String rider)
	{
			...
			if (player.getEquipmentInSlot(2)!= null){
				if (player.getEquipmentInSlot(3)!= null){
					if (player.getEquipmentInSlot(4)!= null){
						if (player.getEquipmentInSlot(2).getItem() == RiderItems.kuugalegs){
							if (player.getEquipmentInSlot(3).getItem() == RiderItems.kuugatroso){
								if (player.getEquipmentInSlot(4).getItem() == RiderItems.kuugahead){
									...
									if (player.getEquipmentInSlot(1).getItem() == RiderItems.arcle){

										if (this.get_core(armor)==0){
											player.addPotionEffect(new PotionEffect(Potion.weakness.id, 5, 2));
											...
											if (player.getCurrentEquippedItem()==null)
											{
												player.addPotionEffect(new PotionEffect(Potion.damageBoost.id, 5, 12));
											}
											player.addPotionEffect(new PotionEffect(Potion.resistance.id, 5, 8));
											player.addPotionEffect(new PotionEffect(Potion.moveSpeed.id, 5, 5));
											player.addPotionEffect(new PotionEffect(Potion.jump.id, 5, 6));
	...
	public ModelResourceLocation getModel(ItemStack item, EntityPlayer playerIn, int useRemaining){
		...
		ModelResourceLocation modelresourcelocation = new ModelResourceLocation("kamenridercraftv3:arcle","inventory");
		ModelResourceLocation modelresourcelocation1 = new ModelResourceLocation("kamenridercraftv3:arcle_b","inventory");
		ModelResourceLocation modelresourcelocation2 = new ModelResourceLocation("kamenridercraftv3:arcle_gr","inventory");
		ModelResourceLocation modelresourcelocation3 = new ModelResourceLocation("kamenridercraftv3:arcle_p","inventory");
		ModelResourceLocation modelresourcelocation4 = new ModelResourceLocation("kamenridercraftv3:arcle_u","inventory");
		ModelResourceLocation modelresourcelocation5 = new ModelResourceLocation("kamenridercraftv3:arcle_ru","inventory");

		if (this.Rider=="kuuga"){
			if (this.get_core(item)==2){
				return modelresourcelocation1;
			}else if (this.get_core(item)==3){
				return modelresourcelocation2;
			}else if (this.get_core(item)==4){
				return modelresourcelocation3;
			}else if (this.get_core(item)==11){
