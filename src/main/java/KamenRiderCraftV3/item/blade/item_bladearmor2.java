...
public class item_bladearmor2 extends ItemArmor
{
	...
	public item_bladearmor2 (ArmorMaterial par2EnumArmorMaterial, int par3, int par4)
	{
	...
	public String getArmorTexture(ItemStack stack, Entity entity, int slot, String type)
	{
		...
		if (entity instanceof EntityLivingBase){
			...
			if (player.getEquipmentInSlot(1)!= null){
				...
				if (player.getEquipmentInSlot(1).getItem() instanceof item_bladedriver){

		String rider = ((item_bladedriver)player.getEquipmentInSlot(1).getItem()).Rider;
					
					if ( slot == 2)
					{
						return "KamenRiderCraftV3:textures/armor/"+rider+CoreName[item_bladedriver.get_core(player.getEquipmentInSlot(1))] +"_2.png";
					}
					if (slot == 0||slot == 1 )
					{
						return "KamenRiderCraftV3:textures/armor/"+rider+ CoreName[item_bladedriver.get_core(player.getEquipmentInSlot(1))] +"_1.png";
					}
