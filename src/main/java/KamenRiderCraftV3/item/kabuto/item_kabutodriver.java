...
public class item_kabutodriver extends ItemArmor
{
	...
	public item_kabutodriver (ArmorMaterial par2EnumArmorMaterial, int par3, int par4, String rider)
	{
						...
						if (player.getEquipmentInSlot(2).getItem() == RiderItems.kabutolegs){
							if (player.getEquipmentInSlot(3).getItem() == RiderItems.kabutotroso){
								if (player.getEquipmentInSlot(4).getItem() == RiderItems.kabutohead){
									...
									if (player.getEquipmentInSlot(1).getItem() == RiderItems.kabuto_rider_belt){
									...
									}else if (player.getEquipmentInSlot(1).getItem() == RiderItems.dark_kabuto_rider_belt){
										if (this.get_core(armor)==1){
											player.addPotionEffect(new PotionEffect(Potion.resistance.id, 5, 1));
											player.addPotionEffect(new PotionEffect(Potion.moveSlowdown.id, 5, 0));
										}else if (this.get_core(armor)==0){
									...
									}else if (player.getEquipmentInSlot(1).getItem() == RiderItems.gatack_rider_belt){
										if (this.get_core(armor)==1){
											player.addPotionEffect(new PotionEffect(Potion.resistance.id, 5, 1));
											player.addPotionEffect(new PotionEffect(Potion.moveSlowdown.id, 5, 0));
										}else if (this.get_core(armor)==0){
									...
									}else if (player.getEquipmentInSlot(1).getItem() == RiderItems.thebee_rider_belt){
										if (this.get_core(armor)==1){
											player.addPotionEffect(new PotionEffect(Potion.resistance.id, 5, 1));
											player.addPotionEffect(new PotionEffect(Potion.moveSlowdown.id, 5, 0));
										}else if (this.get_core(armor)==0){
									...
									}else if (player.getEquipmentInSlot(1).getItem() == RiderItems.drake_rider_belt){
										if (this.get_core(armor)==1){
											player.addPotionEffect(new PotionEffect(Potion.resistance.id, 5, 1));
											player.addPotionEffect(new PotionEffect(Potion.moveSlowdown.id, 5, 0));
										}else if (this.get_core(armor)==0){
									...
									}else if (player.getEquipmentInSlot(1).getItem() == RiderItems.sasword_rider_belt){
										if (this.get_core(armor)==1){
											player.addPotionEffect(new PotionEffect(Potion.resistance.id, 5, 1));
											player.addPotionEffect(new PotionEffect(Potion.moveSlowdown.id, 5, 0));
										}else if (this.get_core(armor)==0){
									...
									}else if (player.getEquipmentInSlot(1).getItem() == RiderItems.kickhopper_rider_belt){
										...
										player.addPotionEffect(new PotionEffect(Potion.jump.id, 5, 7));
									

									}else if (player.getEquipmentInSlot(1).getItem() == RiderItems.puchhopper_rider_belt){
									...
									}else if (player.getEquipmentInSlot(1).getItem() == RiderItems.hercus_rider_belt){
									...
									}else if (player.getEquipmentInSlot(1).getItem() == RiderItems.ketaros_rider_belt){
									...
									}else if (player.getEquipmentInSlot(1).getItem() == RiderItems.caucasus_rider_belt){
