...
public class Item_faiz_blaster extends ItemSword
{
    ...
    public Item_faiz_blaster(ToolMaterial par2EnumToolMaterial,Item ore)
    {
        ...
        if (par3EntityPlayer.isSneaking()){
    		...
    		if (par3EntityPlayer.getEquipmentInSlot(1)!= null){
    			...
    			if (par3EntityPlayer.getEquipmentInSlot(1).getItem() == RiderItems.faizdriver){
    					...
    					item_faizdriver.set_core(par3EntityPlayer.getEquipmentInSlot(1),2);
	...
	public ModelResourceLocation getModel(ItemStack item, EntityPlayer playerIn, int useRemaining){
		...
		else{modelresourcelocation = new ModelResourceLocation("kamenridercraftv3"+":"+(item.getUnlocalizedName().substring(5))+"_gun","inventory");
